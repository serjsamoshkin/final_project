...
public abstract class JDBCDaoController {
    ...
    /**
     * Map<Object, Entry> - где Object представляет из себя объект(persistence object, model.entity). Пара хранится в WeakHashMap. Так, если сессия пользователя закончилась,
