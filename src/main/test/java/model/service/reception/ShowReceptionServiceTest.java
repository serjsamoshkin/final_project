...
public class ShowReceptionServiceTest {
    ...
    public void testService(){
        ...
        testServiceWithDuration(Type.PARTIALLY);
        testServiceWithDuration(Type.FULL);
        testServiceWithDuration(Type.END_OF_DAY);

    }

    public void testServiceWithDuration(Type type){

        final ShowReceptionService showReceptionService = Mockito.spy(new ShowReceptionService(dataSource));
        final DataCheckerService dataChecker = Mockito.mock(DataCheckerService.class);
